    ...
    <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
            ...
            <div
                ...
                <div class="text-right">
                    <p class="text-2xl"></p>
                    <p>
                        @if ($eventWithMostReservations)
                            <div>
                                Événement le plus reservés :
                                {{ $eventWithMostReservations->name }}
                                ({{ $eventWithMostReservations->reservations_count }} réservations)
                            </div>
                        @endif
                    </p>
                </div>
        ...
        <div
            ...
            <div class="rounded-t mb-0 px-0 border-0">
                            ...
                            @foreach ($events as $events)
                                <tr class="text-gray-700 dark:text-gray-100">
                                    <th
                                        ...
                                        <img src="{{ url('storage/images/' . $events->image) }}" alt="Mountain"
                                            width="55px" height="60px" class="object-cover">
                                    </th>
                                    ...
                                    <td
                                        ...
                                        <button type="button" data-modal-target="edite-modal{{ $events->id }}"
                                            data-modal-toggle="edite-modal{{ $events->id }}">edit</button>

                                    </td>
                                    <td
                                        class="border-t-0  px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                        <div class="flex items-center">
                                            <form action="{{ route('destroy.event', ['id' => $events->id]) }}"
                                                method="post"
                ...
                <div id="edite-modal{{ $events->id }}" tabindex="-1" aria-hidden="true"
                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        <!-- Modal content -->

                        <form method="post" action="{{ route('update.event', ['id' => $events->id]) }}"
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div
                                    ...
                                    <button type="button"
                                        ...
                                        data-modal-hide="edite-modal{{ $events->id }}">
                                ...
                                <div class="p-4 md:p-5 space-y-4">
                                    ...
                                    <div class="flex items-center justify-center w-full h-fit">
                                        <label for="dropzone-file"
                                            class="flex flex-col items-center justify-center w-full  border-2 h-fit border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                            ...
                                            <input id="dropzone-file" name="eventimage" type="file"
                                                class="hidden" />
                                        </label>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <label for="first_name"
                                            ...
                                            name</label>
                                        <input type="text" id="first_name" name="eventname"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="John" required value="{{ $events->name }}" />
                                    </div>
                                    <label for="countries"
                                    ...
                                    <div>
                                        <label for="first_name"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">localisation</label>
                                        <input type="text" id="first_name" name="eventlocalisation"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="John" required value="{{ $events->localisation }}" />
                                    </div>

                                    <div>
                                        <label for="first_name"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">description</label>
                                        <input type="text" id="first_name" name="eventdescription"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="John" required value="{{ $events->description }}" />
                                    </div>

                                    <div>
                                        <label for="first_name"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">date</label>
                                        <input type="date" id="first_name" name="eventdate"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="John" required value="{{ $events->date }}" />
                                    </div>

                                    <div>
                                        <label for="first_name"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">place
                                            available</label>
                                        <input type="number" id="first_name" name="eventplace_available"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="John" required value="{{ $events->capacity }}" />
                                    </div>
                                </div>
                                <div>
                                    <label for="first_name"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">description</label>
                                    <input type="text" id="first_name" name="mode"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="John" required value="{{ $events->description }}" />
                                </div>
                                <!-- Modal footer -->
                                <div
                                    ...
                                    <button data-modal-hide="edite-modal{{ $events->id }}" type="submit"
                                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">I
                                        accept</button>

                                    <button data-modal-hide="edite-modal" type="button"
                            ...
                            @foreach ($reservations as $res)
                                <tr class="text-gray-700 dark:text-gray-100">
                                    ...
                                    <td
                                        class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                        <div class="flex items-center">
                                            <form action="{{ route('accepterReservation', ['id' => $res->id]) }}"
                                                method="POST">
                                                @method('put')
                                                @csrf
                                                <input type="hidden" name="status" value="Booked">
                                                <button type="submit"
                                                    class="text-blue-500 hover:text-blue-700 mr-4">Accepter</button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="bg-white p-2 rounded shadow-md">
                    <form action="{{ route('store.organiser') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="place_available" name="place_available"
                                class="w-full border p-2">
                        </div>
